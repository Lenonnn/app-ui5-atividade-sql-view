sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("Seleciona_dados/Dados_SQLView_ZGETV07/app", ".html");
		sHash = sHash || "";
	...
	return Opa5.extend("Seleciona_dados.Dados_SQLView_ZGETV07.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["Seleciona_dados/Dados_SQLView_ZGETV07/localService/mockserver"], function (mockserver) {
